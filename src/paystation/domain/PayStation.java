...
public interface PayStation {
     ...
     */
    public void addPayment(int coinValue, int rateChoice) throws IllegalCoinException;
    ...
    */
    ...
    /**
     * Empties the current total in the paystation. Resets the total amount earned by the
     * paystation.
     * 
